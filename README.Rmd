...
by 50\%? Or how would life expectancy look if infant mortality were eliminated?
...
directly in the R/Rstudio console. The package data is available via the accessor functions 
`data_gbd2021_cod()` and `data_gbd2021_lt()` or the help pages of relevant functions 
